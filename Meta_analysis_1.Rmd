...
'#' to write comments in your code, which does not get read. If you know [Latex](https://www.latex-project.org/), you  can also incorporate this (as with .html)
...
```{r,'Prisma chart', out.width = "450px", echo=F, fig.align='center', fig.cap='PRISMA Flow chart', warning=F, eval=T}
library(PRISMAstatement)
prisma(found = 750,
       found_other = 123,
       no_dupes = 776,
