...
```{r, out.width = "375px", echo=FALSE, fig.align='center', fig.cap='Ronald Fisher (1913)'}
...
Solves some of the issues with vote counting: _p_ = .04 and _p_ = .06 . 
...
```{r, out.width = "250px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/8FiRcf3XYx2i4/giphy.gif")
```

---
## Comparison of methods

```{r, out.width = "625px", echo=FALSE, fig.align='center', fig.cap='Comparison of methods by Koricheva et al. 2013'}
...
* Exploration: explore a research question (e.g., compile a list of risks for job loss)
...
```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("trash.gif") # meme generator.
```
...
```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("X-files.gif") # meme generator. giphy
```
...
(incidentally 9 according to [this paper](https://peerj.com/preprints/2978/).)
...
**S**ample **P**henomon of **I**nterest **D**esign **E**valuation **R**esearch type ([Methley et al. 2014](https://bmchealthservres.biomedcentral.com/articles/10.1186/s12913-014-0579-0))
...
```{r, out.width = "350px", echo=FALSE, fig.align='center', include=TRUE}
knitr::include_graphics("https://media.giphy.com/media/3oKIPqsXYcdjcBcXL2/giphy.gif") # Giphy fair use
```
...
```{r, out.width = "350px", echo=FALSE, fig.align='center', include=TRUE}
knitr::include_graphics("https://media.giphy.com/media/26BGGp9NoFefWZFPG/giphy.gif") # Giphy fair use
```
...
```{r, out.width = "300px", echo=FALSE, fig.align='center', include=TRUE}
knitr::include_graphics("https://media.giphy.com/media/bxYGpFWlvuWnC/giphy.gif") # Giphy fair use
```
...
Again, if you know [Latex](https://www.latex-project.org/), you  can also incorporate this (as with .html)
...
## Some basic data analyses / manipulations. 
 ...
 This follows [Whickham & Grolemund (2017)](https://r4ds.had.co.nz/).
...
```{r,'Prisma chart', out.width = "350px", echo=F, fig.align='center', fig.cap='PRISMA Flow chart', warning=F, eval=T}
library(PRISMAstatement)
prisma(found = 750,
       found_other = 123,
       no_dupes = 776,
