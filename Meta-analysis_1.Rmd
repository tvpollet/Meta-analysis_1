...
```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/yRNSxsl1rJEwU/giphy.gif") # meme generator.
```
...
```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/3oEdvddejaTWNpNCTK/giphy.gif") # meme generator.
```
